...
var (
	// ClientManagementMap is a map of attribute names in result type
	// ClientManagement indexed by view name.
	...
	// ClientManagementCollectionMap is a map of attribute names in result type
	// ClientManagementCollection indexed by view name.
